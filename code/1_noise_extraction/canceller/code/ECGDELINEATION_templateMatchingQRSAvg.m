function [ECGavg, avgRLocation, nUSedBeats, templateMatchingThreshold] = ECGDELINEATION_templateMatchingQRSAvg(QRS, ECG, eigenMap, fs, leadStatus, splineCorrection)
...
% 23/10/24, Ines Llorente, update for loop, control number of clusters
% -------------------------------------------------------------------------
