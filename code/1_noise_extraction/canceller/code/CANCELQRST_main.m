function [atrialActivity, atrialActivityIni, atrialActivityEnd, QRS, nComponents] = CANCELQRST_main(ECG, fs, leadStatus, QRS, ECGavg, avgRpos)
...
[ECGavgOnset, ~, ~, ~, ~, ECGavgOffset, ~, ~, ~, ~, ~, ~, ~, ~] = ECGDELINEATION_delineateECG(ECGavg_best, fs, leadStatus, avgRpos);
...
[atrialActivity, atrialActivityIni, nComponents] = CANCELQRST_applyCancellation(ECG, fs, QRS, onset, offset, leadStatus);
