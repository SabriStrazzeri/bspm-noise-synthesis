function [Out1, Out2, Out3] = CANCELQRST_independentComponentAnalysis(mixedsig, varargin)
...
if jumpWhitening == 3
  ...
  if jumpPCA == 2,
    ...
    % Calculate PCA
    [E, D]=CANCELQRST_principalComponentAnalysis(mixedsig, firstEig, lastEig, interactivePCA, verbose);
  end
end
...
if only > 1
  ...
  if jumpWhitening == 3,
    ...
    [whitesig, whiteningMatrix, dewhiteningMatrix] = CANCELQRST_withenVector ...
