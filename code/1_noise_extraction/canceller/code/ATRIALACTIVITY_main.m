function [atrialActivity, atrialActivityIni, atrialActivityEnd, QRS] = ATRIALACTIVITY_main(ECG, fs, QRS, leadStatus, Torso)
...
[ECGavg, posRprom] = ECGDELINEATION_templateMatchingPQRSTAvg_FA_ssm(QRS, ECG, eigenMap, fs, leadStatus);

% Call function to extract atrial activity from QRST cancellation
[atrialActivity, atrialActivityIni, atrialActivityEnd, QRS, ~, ECGavgOnset, ECGavgOffset] = CANCELQRST_main_ssm(ECG, fs, leadStatus, QRS, ECGavg, posRprom);
