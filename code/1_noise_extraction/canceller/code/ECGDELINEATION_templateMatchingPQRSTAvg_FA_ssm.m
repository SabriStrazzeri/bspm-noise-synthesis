function [ECGavg, avgRLocation, nUSedBeats, templateMatchingThreshold, beatOn, beatOff] = ECGDELINEATION_templateMatchingPQRSTAvg_FA_ssm(QRS, ECG, eigenMap, fs, leadStatus, splineCorrection)
